...
TRAIN_INFERENCE_MODEL_TYPES = ("saprot", "esm2", "esmc", "seqdance", "esmdance", "esm2_mlp", "saprot_mlp", "esmc_mlp")
ANNOTATION_MODEL_TYPES = FUSION_MODEL_TYPES

HF_SEQUENCE_MODEL_TYPES = {"saprot", "esm2", "seqdance", "esmdance"}
NON_SAPROT_HF_MODEL_TYPES = {"esm2", "seqdance", "esmdance"}
...
def infer_model_type_from_checkpoint(checkpoint_path):
    # Split on common path separators and name delimiters for stable checkpoint-name inference.
